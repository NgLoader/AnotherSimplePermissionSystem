...
public abstract class SharedBase<This extends SharedBase<?>> implements ProtocolBase, Runnable {

	protected final SharedProtocolAdapter manager;
	...
	public SharedBase(SharedProtocolAdapter manager) {
	...
	public void sendPacket(List<PacketContainer> packets) {
		this.manager.sendPacket(this.players, packets);
	}

	public void sendPacket(PacketContainer... packets) {
		this.manager.sendPacket(this.players, packets);
	}
