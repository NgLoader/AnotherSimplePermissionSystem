...
import de.ngloader.asps.api.bukkit.protocol.scoreboard.ScoreboardObjectiveExtendedScore;
import de.ngloader.asps.bukkit.protocol.team.SharedTeam;
...
public class SharedObjectiveExtendedScore extends SharedObjectiveScore implements ScoreboardObjectiveExtendedScore {
	...
	public SharedObjectiveExtendedScore(SharedObjective objective, BaseComponent name, int score) {
		...
		this.name = ComponentUtil.createHashCode(this);
		this.team = new SharedTeam(this.getAdapter(), this.getName());
